								...
								<div
									...
									<ul class="list-unstyled">
										<li><a class="btn btn-success text-white"
											href="shop-single"><i class="far fa-heart"></i></a></li>
										<li><a class="btn btn-success text-white mt-2"
											href="shop-single"><i class="far fa-eye"></i></a></li>
										<li><a class="btn btn-success text-white mt-2"
											href="shop-single"><i class="fas fa-cart-plus"></i></a></li>
									</ul>
								</div>
							</div>
							<div class="card-body">
								<a href="shop-single" class="h3 text-decoration-none">Oupidatat
									non</a>
								<ul
